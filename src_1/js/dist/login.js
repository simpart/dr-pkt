...
mf.comp.Frame = function (_mf$Component) {
    ...
    function _class(x_opt, y) {
        _classCallCheck(this, _class);

        try {
            var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, 'number' === typeof x_opt ? { param: [x_opt, y] } : x_opt));
    ...
    _createClass(_class, [{
        ...
        value: function initDomConts(prm) {
            try {
                ...
                /* size setting */
                if (null !== prm && 'object' === (typeof prm === 'undefined' ? 'undefined' : _typeof(prm)) && undefined !== prm[0]) {
 ...
 */
mofron.comp.Form = function (_mofron$Component) {
    ...
    function _class(opt) {
        ...
        try {
            ...
            _this.name('Form');
            _this.m_setmsg = false;
            _this.m_setbtn = false;
            _this.prmOpt(opt);
        } catch (e) {
            console.error(e.stack);
            throw e;
...
mofron.Base = function () {
    ...
    _createClass(_class, [{
        ...
        key: 'setPrmOpt',
        value: function setPrmOpt(po) {
            try {
                if (undefined === po || null === po) {
                    return;
                }
                if ('object' !== (typeof po === 'undefined' ? 'undefined' : _typeof(po)) || undefined !== po[0]) {
                    /* prm-opt is paramter */
                    this.param(po);
                } else if (null !== po) {
                    /* prm-opt is option */
            ...
            try {
                ...
                for (var opt_idx in opt) {
                    if ('function' === typeof this[opt_idx]) {
                        if ('prmOpt' === this[opt_idx] || 'name' === this[opt_idx]) {
...
mofron.func.getTemp = function (key) {
    try {
...
mofron.func.setTemp = function (key, val) {
    try {
        mofron.temp[key] = val;
    } catch (e) {
        console.error(e.stack);
...
mofron.Dom = function (_mofron$Base) {
    ...
    function _class(tg, cmp) {
        ...
        try {
            var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, tg));
            ...
            try {
                ...
                if (true === mofron.debug) {
                    ...
                    for (var cidx in nm_lst) {
                        ...
                        if ('i' !== 'I'.toLowerCase()) {
                            cmp_str += nm_lst[cidx].replace(/[A-Z]/g, function (ch) {
    ...
    _createClass(_class, [{
        ...
        value: function initDomConts(prm) {
            try {
                ...
                /* add frame */
                this.contents().addChild(this.frame());
        ...
        value: function themeConts() {
            try {
                /* set wrap color */
                var color = this.theme().color();
                if (null !== color) {
                    var red = color[0].rgba()[0];
                    var grn = color[0].rgba()[1];
                    var ble = color[0].rgba()[2];
                    var set_clr = new mf.Color(254 < red + 20 ? 255 : red + 20, 254 < grn + 20 ? 255 : grn + 20, 254 < ble + 20 ? 255 : ble + 20);
                    this.contents().style({
        ...
        value: function resizeEvent(base) {
            try {
                _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'resizeEvent', this).call(this, base);
    ...
    _createClass(_class, [{
        ...
        value: function image(img) {
            try {
                ...
                if (undefined === img) {
                    /* getter */
                    return 0 !== ttl.length || true === mf.func.isInclude(ttl[0], 'Image') ? ttl[0] : null;
                }
                /* setter */
...
mf.comp.Ttlhdr = function (_Header) {
    ...
    _createClass(_class, [{
        ...
        value: function title(val) {
            try {
                var ttlbase = this.titleBase().child();
                if (undefined === val) {
                    /* getter */
                    return ttlbase;
                }
                /* setter */
                if ('object' === (typeof val === 'undefined' ? 'undefined' : _typeof(val)) && undefined !== val[0]) {
                    for (var vidx in val) {
                        if (0 === vidx && 0 === ttlbase.length) {
        ...
        key: 'addTitle',
        value: function addTitle(val) {
            try {
                var _ttl = this.titleBase();
                var set_val = null;
                if (true === mf.func.isInclude(val, 'Text')) {
                    set_val = val;
                    _ttl.addChild(set_val);
                    set_val.size(null === set_val.size() ? 35 : undefined);
        ...
        value: function color(clr) {
            try {
                ...
                var _ttl2 = this.title();
                if (0 !== _ttl2.length) {
                    for (var tidx in _ttl2) {
                        this.setTitleColor(_ttl2[tidx]);
                    }
                }
            } catch (e) {
                console.error(e.stack);
 ...
 */
mofron.comp.LoginForm = function (_Form) {
    ...
    _createClass(_class, [{
        ...
        key: 'addChild',
        value: function addChild(chd, disp, idx) {
            try {
                if (true === mofron.func.isInclude(this, 'LoginForm')) {
                    this.initFormComp();
                }
                _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addChild', this).call(this, chd, disp, idx);
            } catch (e) {
                console.error(e.stack);
                throw e;
            }
        ...
        value: function input(inp) {
            try {
                ...
                var fom_chd = this.child();
                if (0 !== fom_chd.length) {
                    for (var fidx in fom_chd) {
                        if (true === mf.func.isInclude(fom_chd[fidx], 'Input')) {
                            inp.execOption(fom_chd[fidx].getOption());
                            fom_chd[fidx].updChild(fom_chd[fidx], inp);
                        }
                    }
                }
                this.m_input = inp;
...
mofron.comp.Button = function (_mofron$Component) {
    ...
    _createClass(_class, [{
        ...
        value: function initDomConts(prm) {
            try {
                /* init contents */
                this.adom().addChild(new mf.Dom('button', this));
        ...
        value: function themeConts(thm) {
            try {
                /* set text component */
                var txt = thm.component('mofron-comp-text');
                if (null !== txt && true === mf.func.isObject(this.text(), 'Text')) {
 ...
 * @brief text component for mofron
 */
mofron.comp.Message = function (_Frame) {
    ...
    _createClass(_class, [{
        ...
        value: function initDomConts(prm) {
            try {
                _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'initDomConts', this).call(this);
                var thm = this.theme();
                this.addChild(new Text(null === prm ? '' : prm));
                /* frame setting */
                this.size(null, null);
                this.text().style({
                    margin: '10px'
        ...
        value: function addChild(chd, disp) {
            try {
                ...
                _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addChild', this).call(this, chd, disp);
            } catch (e) {
                console.error(e.stack);
                throw e;
            }
        ...
        value: function color(clr) {
            try {
                ...
                _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'color', this).call(this, clr);
            } catch (e) {
                console.error(e.stack);
                throw e;
            }
    ...
    _createClass(_class, [{
        ...
        value: function initDomConts(prm) {
            try {
                ...
                this.vdom().addChild(new mofron.Dom({
                    tag: 'div',
                    target: this,
                    child: [lbl, inp]
                }));
